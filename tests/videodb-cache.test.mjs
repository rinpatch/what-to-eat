...
test("raw Supabase reels map into VideoDB seed posts", () => {
  const rows = rawReelsToVideoDbPosts([
    {
      reel_id: "reel-1",
      creator_id: "creator-1",
      url: "https://instagram.example/reel/1",
      video_url: "https://cdn.example/reel.mp4",
      caption: "best noodles",
      likes: 1,
      comments: 2,
      shares: 3,
      views: 4,
      posted_at: "2026-06-13T00:00:00.000Z",
    },
  ], { "creator-1": "tester" });

  assert.equal(rows[0].post_id, "reel-1");
